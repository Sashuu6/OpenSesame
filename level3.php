...
<html>
<head>
  <title>Level 3- OpenSesame</title>
  <meta charset="utf-8">
  ...
  <h2>Level 3 </h2>
      <div id="qstn" class="col-lg-8">
        ...
        <?php
          ...
          // echo "hello";
          $sql="select * from QuestionTable where QuestionNo=3";
              ...
              if(isset($_POST["btnSubmit"]))
              {
               $typepass=strtoupper(mysqli_real_escape_string($con,$_POST["txtAnswer"]));
                        if($typepass == $pass)
                        {
                          ...
                          $id=$_SESSION["userid"];
                          $sql="update ScoreTable set Level3=10,Total=30 where DcodId='$id' and ContestantName='$name'";

...
<html>
<head>
  <title>Level 5- OpenSesame</title>
  <meta charset="utf-8">
  ...
  <h2>Level 5 </h2>
      <div id="qstn" class="col-lg-8">
        ...
        <?php
          ...
          // echo "hello";
          $sql="select * from QuestionTable where QuestionNo=5";
              ...
              if(isset($_POST["btnSubmit"]))
              {
               $typepass=strtoupper(mysqli_real_escape_string($con,$_POST["txtAnswer"]));
                        if($typepass == $pass)
                        {
                          ...
                          $id=$_SESSION["userid"];
                          $sql="update ScoreTable set Level5=10,Total=50 where DcodId='$id' and ContestantName='$name'";
